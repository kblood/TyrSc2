...
namespace Tyr.Agents
{
    class UnitTypes
    {
        ...
        public static HashSet<uint> TerranUnitTypes = new HashSet<uint>()
        {
            SCV, MARINE, MARAUDER, SIEGE_TANK, SIEGE_TANK_SIEGED, BATTLECRUISER, VIKING_ASSUALT, VIKING_FIGHTER, GHOST, THOR, THOR_SINGLE_TARGET, HELLBAT, HELLION, WIDOW_MINE, WIDOW_MINE_BURROWED, MEDIVAC,
            LIBERATOR, LIBERATOR_AG, CYCLONE, AUTO_TURRET, RAVEN, BANSHEE, POINT_DEFENSE_DRONE, REAPER,

            COMMAND_CENTER, COMMAND_CENTER_FLYING, SUPPLY_DEPOT, SUPPLY_DEPOT_LOWERED, FACTORY, FACTORY_FLYING, FACTORY_REACTOR, FACTORY_TECH_LAB, BARRACKS, BARRACKS_FLYING, BARRACKS_REACTOR, BARRACKS_TECH_LAB,
            FUSION_CORE, MISSILE_TURRET, BUNKER, PLANETARY_FORTRESS, ORBITAL_COMMAND, ORBITAL_COMMAND_FLYING, REFINERY, GHOST_ACADEMY, TECH_LAB, REACTOR, STARPORT, STARPORT_FLYING, STARPORT_REACTOR, STARPORT_TECH_LAB,
            SENSOR_TOWER, ARMORY
        };
        public static HashSet<uint> ZergUnitTypes = new HashSet<uint>()
        {
            LARVA, DRONE, DRONE_BURROWED, QUEEN, QUEEN_BURROWED, ZERGLING, ZERGLING_BURROWED, ROACH, ROACH_BURROWED, RAVAGER, RAVAGER_BURROWED, HYDRALISK, HYDRALISK_BURROWED, ULTRALISK, ULTRALISK_BURROWED,
            MUTALISK, CORRUPTOR, BROODLING, BROODLING_ESCORT, BROOD_LORD, BROOD_LORD_COCOON, BANELING, BANELING_BURROWED, BANELING_COCOON, OVERLORD_COCOON, OVERLORD, OVERSEER,
            INFESTED_TERRANS_EGG, INFESTOR, INFESTOR_BURROWED, INFESTOR_TERRAN, INFESTOR_TERRAN_BURROWED, LURKER, LURKER_BURROWED, EGG, LOCUST_FLYING,
            CHANGELING, CHANGELING_MARINE, CHANGELING_MARINE_SHIELD, CHANGELING_ZEALOT, CHANGELING_ZERGLING, CHANGELING_ZERGLING_WINGS,

            HATCHERY, LAIR, HIVE, SPAWNING_POOL, ROACH_WARREN, HYDRALISK_DEN, LURKER_DEN, SPIRE, GREATER_SPIRE, INFESTATION_PIT, ULTRALISK_CAVERN, BANELING_NEST,
            EXTRACTOR, SPORE_CRAWLER, SPORE_CRAWLER_UPROOTED, SPINE_CRAWLER, SPINE_CRAWLER_UPROOTED, NYDUS_NETWORK, NYDUS_CANAL, EVOLUTION_CHAMBER, CREEP_TUMOR, CREEP_TUMOR_BURROWED, CREEP_TUMOR_QUEEN
        };

        public static HashSet<uint> ProtossUnitTypes = new HashSet<uint>()
        {
            PROBE, SENTRY, ZEALOT, STALKER, ADEPT, ADEPT_PHASE_SHIFT, IMMORTAL, HIGH_TEMPLAR, DARK_TEMPLAR, ARCHON, COLOSUS,
            PHOENIX, ORACLE, DISRUPTOR, DISRUPTOR_PHASED, VOID_RAY, CARRIER, OBSERVER, MOTHERSHIP, WARP_PRISM, WARP_PRISM_PHASING, INTERCEPTOR,

            NEXUS, ASSIMILATOR, PYLON, GATEWAY, WARP_GATE, PHOTON_CANNON, TEMPLAR_ARCHIVE, DARK_SHRINE, STARGATE, ROBOTICS_BAY, ROBOTICS_FACILITY, TWILIGHT_COUNSEL,
            FORGE, CYBERNETICS_CORE, PHOTON_CANNON, SHIELD_BATTERY, FLEET_BEACON, FORCE_FIELD
        };

        public static Race GetUnitTypeRace(uint type)
        {
            if (TerranUnitTypes.Contains(type))
                return Race.Terran;
            if (ZergUnitTypes.Contains(type))
                return Race.Zerg;
            if (ProtossUnitTypes.Contains(type))
                return Race.Protoss;
